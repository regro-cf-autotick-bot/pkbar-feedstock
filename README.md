...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pkbar-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14351&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pkbar-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pkbar` can be installed with:

```
conda install pkbar
```

It is possible to list all of the versions of `pkbar` available on your platform with:
